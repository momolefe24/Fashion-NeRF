...
import torch.nn as nn
import torch.nn.functional as F
from VITON.Parser_Based.ACGPN.ACGPN_train.grid_sample import grid_sample
from torch.autograd import Variable
from VITON.Parser_Based.ACGPN.ACGPN_train.tps_grid_gen import TPSGridGen
import ipdb
...
class Vgg19(torch.nn.Module):
    def __init__(self, opt, requires_grad=False):
        ...
        vgg.load_state_dict(torch.load("/gluster/mmolefe/checkpoints/vgg19-dcbb9e9d.pth"))
