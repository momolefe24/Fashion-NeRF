...
from VITON.Parser_Based.ACGPN.ACGPN_inference.util.image_pool import ImagePool
import torch.nn as nn

import cv2
from VITON.Parser_Based.ACGPN.ACGPN_inference.models.base_model import BaseModel
from VITON.Parser_Based.ACGPN.ACGPN_inference.models import networks
...
class Pix2PixHDModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # load networks
        if not self.isTrain or opt.g1_save_final_checkpoint_dir:
