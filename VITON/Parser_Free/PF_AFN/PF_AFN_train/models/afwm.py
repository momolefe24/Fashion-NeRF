...
import numpy as np
from VITON.Parser_Free.PF_AFN.PF_AFN_train.options.train_options import TrainOptions
from VITON.Parser_Free.PF_AFN.PF_AFN_train.models.correlation import correlation # the custom cost volume layer
