...
from VITON.Parser_Free.PF_AFN.PF_AFN_train.train_PFAFN_e2e import process_opt
import datetime
import cv2
...
def train_fsvton_e2e_(opt_, root_opt_, run_wandb=False, sweep=None):
    ...
    if sweep is not None:
        ...
        wandb.agent(sweep_id,_train_fsvton_e2e_sweep,count=3)
    elif run_wandb:
        import wandb
        wandb.login()
