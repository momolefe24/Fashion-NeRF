...
cd $CIHP_PGN_dir
pwd
echo "CIHP_PGN_dir: ${CIHP_PGN_dir}"
echo "inference_pipeline_dir: ${inference_pipeline_dir}"
echo "CIHP_PGN: ${cihp_pgn_root_dir}"
python3 inf_pgn.py --root_dir "${cihp_pgn_root_dir}" --person ${person} --clothing ${clothing} --filename ${filename}
# python3 inf_pgn.py
# python3 ../../../CIHP_PGN/inf_pgn.py --root_dir ../data/rail/inference --person julian --clothing gray_long_sleeve --filename julian_gray_long_sleeve_0_.jpg
